...
const PrintAllRiderParcel = ({ allRiderParcelListData, togglePrintClick }) => {
    ...
    console.log("data:", allRiderParcelListData)



    const total_collect_amount = allRiderParcelListData?.data?.result?.reduce((total, item) => {
        return total + parseFloat(item?.total_collect_amount || 0);
    }, 0);

    const collectedAmountTotal = allRiderParcelListData?.data?.result?.reduce((total, item) => {
        return total + parseFloat(item?.customer_collect_amount || 0);
    }, 0);

    const cod_charge = allRiderParcelListData?.data?.result?.reduce((total, item) => {
        return total + parseFloat(item?.cod_charge || 0);
    }, 0);

    const total_charge = allRiderParcelListData?.data?.result?.reduce((total, item) => {
    ...
    return (
        <div>
            <ReactToPrint
                trigger={() => {
                    return (
                        <button className='border border-gray-200 text-white p-[9px] bg-blue-500 rounded-sm' onClick={togglePrintClick}>
            ...
            <div className='hidden '>
                <div className='w-full mt-10 text-gray-700 ' ref={componentRef} >
                    ...
                    <div className=' flex flex-col text-center items-center justify-center'>
                        ...
                        <p className='text-xl font-semibold mt-1'>Rider Parcel list Info</p>
                                ...
                                <table style={tableStyle}>
                                    <thead>
                                        <tr>
                                            ...
                                            <th className='font-bold  text-[5px] ' style={thStyle}>Parcel Status</th>
                                            <th className='font-bold  text-[5px] ' style={thStyle}>Parcel OTP</th>
                                            <th className='font-bold  text-[5px] ' style={thStyle}> Delivery Person / Hub</th>
                                            <th className='font-bold  text-[5px] ' style={thStyle}> Return Rider</th>
                                            ...
                                            <th className='font-bold  text-[5px] ' style={thStyle}>Weight</th>
                                            ...
                                            <th className='font-bold text-[5px] ' style={thStyle}>Collected Amount </th>
                                            ...
                                            <th className='font-bold  text-[5px] ' style={thStyle}>Note</th>
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            allRiderParcelListData?.data?.result?.map((details, index) => (
                                                <tr key={details?.id}>
                                                    ...
                                                    <td className='text-[5px]' style={tdStyle}>{details?.delivery_rider?.name} </td>
                                                    <td className='text-[5px]' style={tdStyle}>{details?.return_rider?.name} </td>
                                                    ...
                                                    <td className='text-[5px]' style={tdStyle}>{details?.weight_package?.name}</td>
                                                    ...
                                                    <td className='text-[5px]' style={tdStyle}>{details?.note}</td>
                                                    <td className='text-[5px]' style={tdStyle}>
                                                        {/* {
                                        ...
                                        <tr>
                                            ...
                                            <td className='text-[11px]' style={tdStyle}>{parseFloat(total_collect_amount).toFixed(2)} </td>
                                            <td className='text-[11px]' style={tdStyle}>{parseFloat(collectedAmountTotal).toFixed(2)} </td>
                                            <td className='text-[11px]' style={tdStyle}>{parseFloat(cod_charge).toFixed(2)} </td>
                                            <td className='text-[11px]' style={tdStyle}>{parseFloat(total_charge).toFixed(2)} </td>
                                            <td className='text-[11px]' style={tdStyle}></td>
                                            <td className='text-[11px]' style={tdStyle}></td>
                                            <td className='text-[11px]' style={tdStyle}></td>
                                            <td className='text-[11px]' style={tdStyle}></td>
...
export default PrintAllRiderParcel;
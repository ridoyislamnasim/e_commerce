...
const PrintCompleteDeliveryPayment = ({ completeDeliveryPaymentPrintData, togglePrintClick }) => {
    ...
    console.log("data", completeDeliveryPaymentPrintData)
            ...
            <div className='hidden '>
                <div className='w-full mt-10 text-gray-700 ' ref={componentRef} >
                    ...
                    <div className=' flex flex-col text-center items-center justify-center'>
                        ...
                        <p className='text-xl font-semibold mt-1'>Complete Delivery Parcel List</p>
                            ...
                            <div className=' text-gray-700'>
                                <table style={tableStyle}>
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            completeDeliveryPaymentPrintData?.data?.result?.map((details, index) => (
                                                <tr key={details?.id}>
...
export default PrintCompleteDeliveryPayment;
...
// const PrintTradingBill = React.forwardRef<HTMLDivElement, PrintBillProps>(
...
//                   <TableHead className="h-8  text-left px-2">Sl.</TableHead>
...
//                   <TableHead className="h-8  text-left px-2">Unit</TableHead>
...
//                       <TableCell className="py-2 px-2  text-end">
//                         {item.brand}
//                       </TableCell>
//                       <TableCell className="py-2 px-2 ">{item.model}</TableCell>
//                       <TableCell className="py-2 px-2 text-end">
//                         {item.quantity}
//                       </TableCell>
//                       <TableCell className="py-2 px-2 text-end">
...
//                     )}
//                   </TableCell>
//                   <TableCell className="py-2 px-2  text-end"></TableCell>
//                 </TableRow>
//               </TableFooter>
//             </Table>
//           </div>
...
// PrintTradingBill.displayName = "PrintTradingBill";

// export default PrintTradingBill;

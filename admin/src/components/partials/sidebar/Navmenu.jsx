...
const Navmenu = () => {
	...
	const {data} = useGetSingleRoleByIdQuery({id:auth?.user?.roleRef})
	// console.log("role", auth?.user?.roleRef);
	
	const permissions = data?.data?.permissions	;
	// console.log("permissions", permissions)
	const userRole = auth?.user?.role;
	const menus = navMenu( userRole, permissions);
// console.log("have you", menus)

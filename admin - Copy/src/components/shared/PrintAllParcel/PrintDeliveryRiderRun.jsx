...
const PrintDeliveryRiderRun = ({ deliveryRiderRunData }) => {
    ...
    const totalRunParcel = deliveryRiderRunData?.data?.result?.reduce((total, item) => {
        return total + parseFloat(item?.total_run_parcel || 0);
    }, 0);

    const totalRunCompleteParcel = deliveryRiderRunData?.data?.result?.reduce((total, item) => {
            ...
            <div className='hidden '>
                <div className='w-full mt-10 text-gray-700 ' ref={componentRef} >
                    ...
                    <div className=' flex flex-col text-center items-center justify-center'>
                        ...
                        <p className='text-xl font-semibold mt-1'>Delivery Rider Run List</p>
                            ...
                            <div className=' text-gray-700'>
                                <table style={tableStyle}>
                                    ...
                                    <tbody>
                                        ...
                                        {
                                            deliveryRiderRunData?.data?.result?.map((details, index) => (
                                                <tr key={details?.id}>
...
export default PrintDeliveryRiderRun;
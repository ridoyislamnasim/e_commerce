...
// import SelectDiscountType from '@/components/shared/Select/SelectTransferDiscountType';
...
// import { useCreateAdminTransferMutation, useUpdateTransferMutation } from '@/store/api/app/Transfer/transferApiSlice';
const TransferForm = ({ id, data }) => {
	...
	const {
		...
		setValue,
		isLoading,
	} = useSubmit(id, id ? useUpdateTransferMutation : useCreateAdminTransferMutation);
	...
	return (
		<form onSubmit={handleSubmit(handleFormSubmit)}>
			<Card title={id ? 'Edit Transfer' : 'Create New Transfer'}>

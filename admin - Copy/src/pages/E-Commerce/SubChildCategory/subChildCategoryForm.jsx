...
} from '@/store/api/app/SubChildCategory/subChildCategoryApiSlice';
import { useEffect } from 'react';
import { useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';

const SubChildCategoryForm = ({ id, data }) => {
	...
	const {
		...
		watch,
		isLoading,
	} = useSubmit(id, id ? useUpdateSubChildCategoryMutation : useCreateSubChildCategoryMutation);
	...
	return (
		<form onSubmit={handleSubmit(handleFormSubmit)}>
			<Card title={id ? 'Edit SubChildCategory' : 'Create New Child Category'}>
...
export default SubChildCategoryForm;
